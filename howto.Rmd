---
title: Short tutorial on using functions in package "intergraph"
...
* See homepage on [http://mbojan.github.io/intergraph](http://mbojan.github.io/intergraph).
* Get to package development pages on [https://github.com/mbojan/intergraph](https://github.com/mbojan/intergraph).
...
* R input code is shown in frames with grey background
* R output is shown in frames with white background with lines
preceded with `##` (two hash symbols).
...
RMarkdown source of this document can be found [here](howto.Rmd).
The most up-to-date version is always available as a package vignette.
...
* Network-level attribute `layout` storing a function that computes the vertex
  placement for plotting. It is a copy of `layout.fruchterman.reingold` function
  from package igraph.
